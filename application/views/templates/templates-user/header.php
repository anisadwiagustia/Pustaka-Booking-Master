            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav">
                    ...
                    ?>
                        ...
                        <a href="<?= base_url() . 'booking/exportToPdf/' . $this->session->userdata('id_user'); ?>" class="nav-item nav-link" onclick="information('Waktu Pengembalian Buku 1x24 Jam dari booking!!!')"> Cetak Bukti Booking </a>

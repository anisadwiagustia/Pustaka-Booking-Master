...
<ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item">
        <a href="<?= base_url('buku/kategori'); ?>" class="nav-link pb-0">
            ...
            <span>
                Kategori Buku (<?=$this->db->query("select*from kategori")->num_rows();?>)
            </span>
        </a>
    </li>
    <li class="nav-item">
        <a href="<?= base_url('buku'); ?>" class="nav-link pb-0">
            <i class="fa fa-fw fa-book"></i>
            <span>
                Data Buku (<?=$this->db->query("select*from buku")->num_rows();?>)
            </span>
        </a>
    </li>
    <li class="nav-item">
    ...
    <li class="nav-item">
        <a href="<?= base_url('pinjam'); ?>" class="nav-link pb-0">
            ...
            <span>
                Data Peminjaman(<?=$this->db->query("select*from pinjam")->num_rows();?>)
            </span>
        </a>
    </li>
    <li class="nav-item">
        <a href="<?= base_url('pinjam/daftarBooking'); ?>" class="nav-link pb-0">
            ...
            <span>
                Data Booking(<?=$this->db->query("select*from booking")->num_rows();?>)
            </span>
        </a>
    </li>
    </li>
